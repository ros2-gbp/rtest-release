...
Name:           ros-kilted-rtest
Version:        0.2.2
Release:        1%{?dist}%{?release_suffix}
Summary:        ROS rtest package

License:        Apache 2.0
URL:            https://index.ros.org/p/rtest/#kilted
Source0:        %{name}-%{version}.tar.gz

Requires:       ros-kilted-action-msgs
Requires:       ros-kilted-gmock-vendor
...
BuildRequires:  ros-kilted-gmock-vendor
...
%if 0%{?with_tests}
BuildRequires:  ros-kilted-ament-clang-tidy
...
* Sat Mar 07 2026 Gary Cross <gc19@beam.global> - 0.2.1-1
- Autogenerated by Bloom
